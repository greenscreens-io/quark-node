...
const QuarkRequest = require('./Request');
const QuarkEvent = require('./Event');
const QuarkError = require('./Error');
 ...
 */
class QuarkGenerator extends QuarkEvent {
	...
	#apiFn(params) {
		...
		const fn = function () {
			...
			return new Promise((resolve, reject) => {
				try {
					const proxy = QuarkRequest.wrap(req, timeout, (obj) => {
